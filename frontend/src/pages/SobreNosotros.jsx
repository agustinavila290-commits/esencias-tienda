...
export default function SobreNosotros() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 pb-10">
      ...
      {/* Hero */}
      <div className="relative overflow-hidden bg-gradient-to-br from-brand-primary-900 to-brand-primary-700 rounded-3xl p-8 mb-8 text-white">
        <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full bg-surface/5 blur-2xl" />
        ...
        <p className="text-brand-primary-200 text-sm leading-relaxed max-w-sm">
      ...
      <div className="space-y-6">
        <div className="bg-surface rounded-2xl p-6 border border-brand-primary-100 shadow-sm">
          <h2 className="font-display text-xl font-bold text-brand-primary-800 mb-3">¿Quiénes somos?</h2>
        ...
        <div className="bg-surface rounded-2xl p-6 border border-brand-primary-100 shadow-sm">
          <h2 className="font-display text-xl font-bold text-brand-primary-800 mb-3">Nuestro proceso</h2>
          <div className="space-y-3">
            {[
              ...
              <div key={titulo} className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-text-primary text-sm">{titulo}</p>
                  <p className="text-text-secondary text-sm leading-relaxed">{texto}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-brand-primary-50 rounded-2xl p-6 border border-brand-primary-100">
          <h2 className="font-display text-xl font-bold text-brand-primary-800 mb-3">Contacto directo</h2>
