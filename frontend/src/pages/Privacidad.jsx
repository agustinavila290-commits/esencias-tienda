...
export default function Privacidad() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-8 pb-10">
      ...
      <h1 className="font-display text-3xl font-bold text-brand-primary-800 mb-6">Política de privacidad</h1>

      <div className="space-y-5 text-sm text-text-secondary leading-relaxed">
        <section>
          <h2 className="font-display text-lg font-bold text-brand-primary-800 mb-2">1. Responsable</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-lg font-bold text-brand-primary-800 mb-2">2. Qué datos pedimos</h2>
        ...
        <section>
          <h2 className="font-display text-lg font-bold text-brand-primary-800 mb-2">3. Para qué los usamos</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="font-display text-lg font-bold text-brand-primary-800 mb-2">4. Con quién los compartimos</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-lg font-bold text-brand-primary-800 mb-2">5. Tus derechos</h2>
          <p>
            Podés pedir acceder, corregir o eliminar tus datos escribiéndonos desde la
            página de <Link to="/contacto" className="text-brand-primary-600 underline">Contacto</Link>.
          </p>
        </section>
      </div>
    </div>
